// Запуск:
// npx ts-node ./public/manifest/applications/fedapp-dtp-0.0.2.js
...
const { appAngle0360 } = require('../applications/angle-0.3.60')
...
const manifestFilePath = path.join(__dirname, '..', 'build', 'fedapp-dtp-0.0.2.json')
